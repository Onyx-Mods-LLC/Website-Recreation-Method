...
command -v php > /dev/null 2>&1 || { echo >&2 "I require php but it's not installed. Install it mf. Aborting."; exit 1; }
command -v wget > /dev/null 2>&1 || { echo >&2 "I require wget but it's not installed. Install it mf. Aborting."; exit 1; }
command -v unzip > /dev/null 2>&1 || { echo >&2 "I require unzip but it's not installed. Install it mf. Aborting."; exit 1; }
command -v curl > /dev/null 2>&1 || { echo >&2 "I require curl but it's not installed. Install it mf. Aborting."; exit 1; }
...
printf "\n"
printf "     \e[101m\e[1;77m::     Made and created by Null Pull     ::\e[0m\n"
printf "\n"
}
